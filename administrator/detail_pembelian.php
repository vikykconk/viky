...
<div class="card mt-2">
    <div class="card-body">
        ...
        while($d = mysqli_fetch_array($data)){
            ...
            <from method="post" action="simpan_total_harga.php">
                <?php
                ...
                <div class="row">
                    <div class="col-sm-10">
                        <div class="form-group">
                            ...
                            <input type="text"  name="pelanggan_id" value="<?= $d['pelanggan_id'] ?>" >
                            <input type="text"  name="penjualan_id" value="<?= $d['pelanggan_id'] ?>" >
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="form-group">
